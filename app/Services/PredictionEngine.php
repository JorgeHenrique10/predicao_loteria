...
class PredictionEngine
{
    ...
    private const MAX_DEZENA = 60;

    /**
     * Gera jogos preditos baseados em análise estatística.
     *
     * @param int $qtdDezenas Quantidade de dezenas por jogo (6-20)
    ...
    {
        $sorteios = Sorteio::orderBy('concurso', 'desc')->get();
    ...
    /**
     * Calcula o score composto para cada dezena (01-60).
     */
